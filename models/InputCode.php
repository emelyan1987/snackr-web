...
/**
 * This is the model class for table "tbl_input_code".
 *
 * @property string $id
 ...
 */
class InputCode extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->hasOne(Customer::className(), ['id' => 'email']);
    }
}
